...
class PostInfo (private val item  : Post, private val callback  : InteractionEditClick): BottomSheetDialogFragment() {
...
interface InteractionEditClick {
    fun onDeleteListener(item : Post)
    fun onEditListerner(id : String,title : String? , content : String?)
    fun onLaporListener(item: Post)
}